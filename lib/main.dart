              ...
              Row(
                ...
                children: <Widget>[
                  _buildSocialMediaIcon(
                    ...
                    url: 'https://www.facebook.com/harshith.dmdm',
                  ),
                  _buildSocialMediaIcon(
                    context: context, // Pass context to _buildSocialMediaIcon
                    icon: const FaIcon(FontAwesomeIcons.linkedin),
                    url: 'https://www.linkedin.com/in/harshith-dm-11b743249/',
                  ),
                  _buildSocialMediaIcon(
                    context: context, // Pass context to _buildSocialMediaIcon
                    icon: const FaIcon(FontAwesomeIcons.twitter),
                    url: 'https://twitter.com/DmHarshith?t=SGKjoa9fcUUDnjhprPErJQ&s=08',
                  ),
                  _buildSocialMediaIcon(
                    context: context, // Pass context to _buildSocialMediaIcon
                    icon: const FaIcon(FontAwesomeIcons.github),
                    url: 'https://github.com/Harshithdm123',
                  ),
                  _buildSocialMediaIcon(
                    context: context, // Pass context to _buildSocialMediaIcon
                    icon: const FaIcon(FontAwesomeIcons.instagram),
                    url: 'https://instagram.com/_dm_harshith_?utm_source=qr&igshid=YzU1NGVlODEzOA==',
                  ),
                ],
              ),
            ],
