          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const Text('Name: Harshith D M', style: TextStyle(color: Colors.white)),
                const Text('Address: Kadur - Chikkamagalore', style: TextStyle(color: Colors.white)),
                const Text('Number: 9480862495', style: TextStyle(color: Colors.white)),
                const Text('Email: dmharshith0@gmail.com', style: TextStyle(color: Colors.white)),
