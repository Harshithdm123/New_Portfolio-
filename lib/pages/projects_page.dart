      ...
      body: ListView(
        ...
        children: const [
          ProjectCard(
            ...
            description: 'A Pharmacy Management System is a comprehensive software solution that automates the management of pharmacy operations, including inventory control, prescription processing, and sales tracking, to improve efficiency and accuracy.',
            date: '2024-04-13',
            url: 'https://github.com/Harshithdm123/Pharmacy-Management-System',
            icons: [
          ...
          ProjectCard(
            ...
            date: '2023-03-13',
            url: 'https://github.com/Harshithdm123/online-course-management',
            icons: [
              // Icon(Icons.code, color: Colors.white),
              // Icon(Icons.book, color: Colors.white),
            ],
          ...
          ProjectCard(
            title: 'Portfolio',
            description: 'A portfolio is a curated collection of an individual\'s work and accomplishments, showcasing their skills, experience, and achievements to potential employers or clients.',
            date: '2022-03-06',
            url: 'https://github.com/Harshithdm123/portfolio',
            icons: [
              // Icon(Icons.code, color: Colors.white),
