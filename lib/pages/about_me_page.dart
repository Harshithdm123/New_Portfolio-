...
class AboutMePage extends StatelessWidget {
  ...
  Future<void> _downloadCV() async {
    const url = 'https://github.com/Harshithdm123/portfolio/blob/main/DM%20resume%20new.pdf'; // Replace with your actual CV URL
